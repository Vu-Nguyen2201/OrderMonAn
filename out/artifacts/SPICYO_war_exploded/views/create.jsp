...
<jsp:include page="_header.jsp"></jsp:include>
        <div class="footer">
            <div class="container-fluid">
                <div class="row">
                  <div class=" col-md-12">
                    <h2>SPICYO<strong class="white"> Create New</strong></h2>
                  </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                      
                      <form class="main_form" action="create" method="post">
                            <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="img-box">
                            <figure><img style="height:550px" src="images/home2.jpg" alt="img" /></figure>
